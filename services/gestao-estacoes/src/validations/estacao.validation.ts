...
export const createEstacaoSchema = z.object({
  codigo: z.string().min(1, "Código é obrigatório").max(30, "Máximo 30 caracteres"),
  nome: z.string().min(2, "Nome  é obrigatório").max(120, "Nome deve ter no mínimo 2 caracteres"),
  municipio: z.string().min(1, "Município é obrigatório").max(100, "Município deve ter no mínimo 1 caracteres"),
